...
export const environment = {
  ...
  graphQLUri: 'https://sls.abp.vn/sls/graphql',
  apiBaseUrl: 'https://sls.abp.vn/sls/api/',
  apiV2BaseUrl: 'http://localhost:8091/api/v1/',
  // apiV2BaseUrl: 'http://103.97.125.64:8088/api/v1/',
  domain: 'localhost',
  firebase: {
